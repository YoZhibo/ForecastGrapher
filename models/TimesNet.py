...
from layers.Blocks import Inception_Block_V1
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.task_name == 'long_term_forecast' \
                or self.task_name == 'short_term_forecast' or self.task_name == 'mask':
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        if self.task_name == 'long_term_forecast' or \
                self.task_name == 'short_term_forecast' or self.task_name == 'mask':
